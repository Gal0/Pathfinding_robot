...
#grid properties
tileSize= 15#in cm
xTiles, yTiles = 15, 15 #number of tiles in x/y direction
xStart, yStart = 7, 14 #grid-position of start-tile
xGoal, yGoal = 7,7#10, 13 #grid-position of goal-tile
#Canvas colors
...
loadPrevMap = True #If True, the previous stored map will be loaded.
...
def Move(robot):
    ...
    robot.currentHeading = CalibratedComp.getAvHeading(3) #Update heading because it can change from from to place 
